...
# OpenAI API 金鑰
OPENAI_API_KEY = os.getenv("OPENAI_API_KEY")  # 確保替換為您的 OpenAI API 金鑰
OPENAI_MODEL = os.getenv("OPENAI_MODEL", "gpt-4o")  # 確保替換為您的 OpenAI AI 模型

# Anthropic API 金鑰
ANTHROPIC_API_KEY = os.getenv("ANTHROPIC_API_KEY")  # 確保替換為您的 ANTHROPIC_API_KEY 金鑰
ANTHROPIC_MODEL = os.getenv("ANTHROPIC_MODEL", "claude-3-5-sonnet-20240620")  # 確保替換為您的 ANTHROPIC_API_MODEL 模型
# 背景任務排程間隔
